...
pgroutr.get('/profile/:slug/deleted', ensureAuthenticated, function(req, res){
  res.render('deleted');
});

pgroutr.get('/deleted', ensureAuthenticated, function(req, res){
  res.render('deleted', pages.newblog);
});
